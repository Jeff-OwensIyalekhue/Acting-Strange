...
//{JointType.ThumbRight , JointType.WristRight }// rotation of bone endings can't be computed from bone positions 
    ...
    public override Quaternion applyRelativeRotationChange(JointType jt, Quaternion initialModelJointRotation)
    {
        ...
        // rotation between the original and new bone direction in the kinect coordinate system
        ...
        //rotation.eulerAngles = currentModelJointRotation.ToEulerAngles();
        //TODo: quaternion to euler Quaternion.EulerAngles(currentModelJointRotation.ToEulerAngles());
